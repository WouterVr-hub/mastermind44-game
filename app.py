...
class GameState:
    ...
    def get_player_list_data(self):
        # FIX: Send a list of objects, not a list of strings.
        # This ensures the client receives a consistent data structure.
...
def handle_disconnect():
    ...
    if request.sid in GAME.players:
        ...
        if request.sid == GAME.host_sid:
            ...
            GAME = GameState() # Create a new GameState instance
...
# The if __name__ == '__main__': block is not needed for Render deploymentimport eventlet
eventlet.monkey_patch()
